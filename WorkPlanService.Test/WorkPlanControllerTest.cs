...
namespace WorkPlanService.Test
{
    public class WorkPlanControllerTest
    {
        ...
        public WorkPlanControllerTest(IWorkService workService, ShiftController shiftController, WorkPlanController workPlanController)
        {
            _service = workService;
            _shiftController = shiftController;
            _workPlanController = workPlanController;
